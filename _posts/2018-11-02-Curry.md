---
title: "Curry with Python"
published: true
---

## Curry: **WHAT IS** and **HOW WORKS**

Curry is a functional technique, that allow us to use a function partially, that means, we can pass
...
The way that I implemented **Curry** allow to use  **decorator**(@) notation
